...
export class ReviewerService {
  ...
  postReviewingForm(processId,taskId,o):Observable<any>{
    return this.http.post(this.postReviewingFormUrl+processId+"/"+taskId,o);
  }
  ...
  downloadPdf(processId,workId):Observable<any>{
    return this.http.get(this.downloadPdfUrl+processId+"/"+workId,{responseType: 'blob'});
  }
}
